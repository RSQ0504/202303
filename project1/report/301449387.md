...
**We can also increase the white area (feature in relu)  in relu layer feature (3th img) by <span style="color:red">decreasing the values of  w_lr and b_lr.</span>** I had changed w_lr and b_lr to 1.5 and 0.5, the white area (feature in relu) was increased. For the picture I post is still using the default w_lr and b_lr.
